...
from deep_training.zoo.model_zoo.baichuan.baichuan2_13b.llm_model import MyTransformer,BaichuanConfig,BaichuanTokenizer,\
...
class ModelEngine(ModelEngine_Base):
    ...
    def embedding(self, query, **kwargs):
        ...
        inputs = self.tokenizer(query, truncation="longest_first", max_length=self.model_max_length,return_tensors="pt")
