...
from deep_training.zoo.model_zoo.internlm2.llm_model import MyTransformer,InternLM2Config,InternLM2Tokenizer,\
    InternLM2ForCausalLM,PetlArguments,PetlModel
...
class ModelEngine(ModelEngine_Base):
    def _load_model(self,device_id=None):
        ...
        tokenizer, config, _, _ = dataHelper.load_tokenizer_and_config(config_class_name=InternLM2Config,
    ...
    def _load_model_lora(self, device_id=None):
        ...
        if os.path.exists(os.path.join(ckpt_dir, 'config.json')):
            config = InternLM2Config.from_pretrained(ckpt_dir)
